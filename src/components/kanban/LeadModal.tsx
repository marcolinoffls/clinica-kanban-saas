...
export const LeadModal = ({ isOpen, onClose, lead, etapas, onSave, onOpenHistory }: LeadModalProps) => {
  ...
  const handleSave = () => {
    if (validateForm()) {
      // LÓGICA ADICIONADA: Envia o número de telefone sem a formatação para o banco.
      onSave({
        ...formData,
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* LÓGICA ALTERADA: Serviço de Interesse Dinâmico */}
              <div>
