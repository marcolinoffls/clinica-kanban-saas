...
const PLANS = [{
  ...
  priceId: 'price_1RePhVGPYAaRS7MgpBF0h6mT',
  // ID real do Stripe
  popular: false
}, {
  id: 'premium',
  ...
  priceId: 'price_1ReJriGPYAaRS7MgZVpjvFbT',
  // ID real do Stripe
  popular: true
}];
const BillingPage = () => {
  ...
  return <div className="container mx-auto py-8 space-y-8">
      ...
      {subscriptionData && <Card className="max-w-2xl mx-auto">
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                {subscriptionData.subscribed && subscriptionData.subscription_end && <p className="text-sm text-gray-600">
            ...
            {subscriptionData.subscribed && <Button onClick={handleManageSubscription} disabled={isOpeningPortal} className="w-full">
      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        ...
        return <Card key={plan.id} className={`relative ${plan.popular ? 'border-blue-500 shadow-lg' : ''} ${isCurrentPlan ? 'ring-2 ring-green-500' : ''}`}>
              ...
              <CardContent className="space-y-4">
                ...
                <Button onClick={() => handleSelectPlan(plan)} disabled={isCreatingCheckout || isCurrentPlan} variant={isCurrentPlan ? 'secondary' : 'default'} className="w-full rounded-xl">
                  {isCurrentPlan ? 'Plano Atual' : isCreatingCheckout ? 'Processando...' : 'Escolher Plano'}
                </Button>
              </CardContent>
            </Card>;
      })}
      ...
      {/* Exibir erros */}
      {error && <Card className="max-w-2xl mx-auto border-red-200 bg-red-50">
